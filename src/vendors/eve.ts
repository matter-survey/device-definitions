 ...
 */
export const eveThermoCluster: ClusterDefinition = {
  ...
  attributes: [
    {
      ...
      access: ['R'],
      description:
        'Heating schedule binary data. Contains weekly schedule with day entries and time slots.',
      parser: 'eve.schedule',
    },
    {
 ...
 */
export const eveThermoScheduleExtension: DeviceExtension = {
 ...
 */
export const eveThermo: DeviceDefinition = {
  id: 'eve_thermo',
  fingerprint: {
    vendorId: EVE_VENDOR_ID,
  ...
  model: 'Eve Thermo',
  description:
    'Smart radiator valve with Thread/Matter, HomeKit and weekly heating schedules',
...
/** All Eve clusters */
export const eveClusters: ClusterDefinition[] = [eveThermoCluster];

/** All Eve devices */
export const eveDevices: DeviceDefinition[] = [eveThermo];
