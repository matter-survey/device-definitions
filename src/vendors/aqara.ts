 ...
 */
export const aqaraLockCluster: ClusterDefinition = {
  id: AQARA_LOCK_CLUSTER_ID,
  vendorId: AQARA_VENDOR_ID,
  name: 'Aqara Lock Settings',
  description:
    'Aqara proprietary lock settings cluster. Attribute meanings are partially documented.',
  attributes: [
    {
      id: 0x115f0011,
      name: 'setting1',
 ...
 * Purpose unknown.
 */
export const aqaraUnknownCluster: ClusterDefinition = {
 ...
 */
export const aqaraLockExtension: DeviceExtension = {
 ...
 */
export const aqaraU200Lock: DeviceDefinition = {
  id: 'aqara_u200',
  fingerprint: {
    vendorId: AQARA_VENDOR_ID,
  ...
  description:
    'Smart lock with Matter, fingerprint reader, NFC, and smartphone unlock',
 ...
 */
export const aqaraW100: DeviceDefinition = {
  id: 'aqara_w100',
  fingerprint: {
    vendorId: AQARA_VENDOR_ID,
  ...
  description:
    'Temperature and humidity sensor with Matter support. Uses standard clusters only.',
...
/** All Aqara clusters */
export const aqaraClusters: ClusterDefinition[] = [
  aqaraLockCluster,
  aqaraUnknownCluster,
];

/** All Aqara devices */
export const aqaraDevices: DeviceDefinition[] = [aqaraU200Lock, aqaraW100];
